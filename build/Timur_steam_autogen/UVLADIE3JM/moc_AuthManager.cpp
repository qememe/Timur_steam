...
void AuthManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->developerModeChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthManager::*)()>(_a, &AuthManager::userChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AuthManager::*)(bool )>(_a, &AuthManager::developerModeChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void AuthManager::userChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AuthManager::developerModeChanged(bool _t1)
{
